...
import { Box, Grid, Link, Typography, Card, IconButton, CircularProgress, Fade, Switch } from '@mui/material';
...
export const GitCommit = ({slim=false, author, date, URL, children})=>{
    ...
    <Link underline="none" href={URL}>
                <Box>
                    <Card style={{margin:"1em", marginLeft:"2em", height:"3em", paddingLeft:"0.33em", backgroundColor:colors.ocean}}>
                        <Card style={{width:"100%", height:"3em", margin:"0%", padding:"0.1em", paddingLeft:"1em", backgroundColor:colors.coal, visibility:"visible"}}>
                            <Typography style={{float:"left", maxWidth:"60vw", overflowX:"hidden", padding:"0.1em"}} variant="overline" fontSize={"1em"} color={colors.paleWhite}>
                                {((children as string).length < charLimitSlim ) ? children : ((children as string).substring(0,(charLimitSlim-1)).concat("..."))}
                            </Typography>
                            <Typography style={{float:"right", maxWidth:"60vw", overflowX:"hidden", padding:"0.1em", marginRight:"3em"}} variant="overline" fontSize={"0.7em"} color={colors.paleWhite}>
                                By {author} on {date}.
                            </Typography>
                        </Card>
                    </Card>
